  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="max-w-3xl text-center sm:mx-auto lg:mr-auto lg:mt-0 lg:w-4/5">
                ...
                <p className="mx-auto mt-8 max-w-2xl text-lg text-muted-foreground">
                  EduCloud is an all-in-one school management system that
                  simplifies attendance, exams, fees, student records, and
                  communication — designed for administrators and teachers.
                </p>
                <ul className="mt-6 flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
                  <li>✔ No manual registers</li>
        ...
        {/* WE CAN UPDATE THIS SECTION LATER TO ADD OUR PARTNERS */}
